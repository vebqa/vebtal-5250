...
/**
 * Replaced by waitForTextNotpresent  
 * @author doerges
 *
 */
@Deprecated
public class Waitfornotvisible extends AbstractCommand {

	public Waitfornotvisible(String aCommand, String aTarget, String aValue) {
